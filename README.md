...
- Site Page Crawler Infrastructure:
  ...
  - **Maximum Redirects**: Maximum Redirects to follow when crawling pages and validating links. Redirect can be caused by locale handling and friendly URLs or login screen etc. Default is 5. Don't change this unless you know what you are doing...
